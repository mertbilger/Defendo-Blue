public enum EventList
        {
            ...
            SuccesfulLogin = 4624,
            [Description("Basarisiz giris")]
            FailedLogin = 4625,
            [Description("Ekran kilitlendi")]
            Unlock = 4800,
            [Description("Ekran kilidi acildi")]
            Lock = 4801,
            [Description("Kullanici oturumunu kapatti")]
            Logoff1 = 4634,
            [Description("Başarılı Logoff")]
            Logoff2 = 4647,
            [Description("Yeni kullanici olusturuldu")]
            NewUserCreated = 4720,
            [Description("Kullanici silindi")]
            UserDeleted = 4726,
            [Description("Loglar silindi")]
            LogsCleared = 1102,
            [Description("Kullanici aktif hale getirildi")]
            AccountEnabled = 4722,
